...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", default="E:\work\PaddleOCR-release-2.7\PaddleOCR-release-2.7\configs\det\det_r50_vd_dcn_fce_ctw.yml", help="configuration file to use")
