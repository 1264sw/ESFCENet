...
def genDetRecTrainVal(args):
    ...
    removeFile(os.path.join(args.detRootPath, "old_test.txt"))
    removeFile(os.path.join(args.recRootPath, "train.txt"))
    removeFile(os.path.join(args.recRootPath, "val.txt"))
    removeFile(os.path.join(args.recRootPath, "old_test.txt"))
    ...
    detTestTxt = open(os.path.join(args.detRootPath, "old_test.txt"), "a", encoding="UTF-8")
    ...
    recTestTxt = open(os.path.join(args.recRootPath, "old_test.txt"), "a", encoding="UTF-8")
